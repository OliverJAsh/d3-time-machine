...
declare namespace Rx {
    interface ObservableStatic {
        ...
        combineLatest<T, T2, T3, T4, T5, T6, T7, T8>(first: Observable<T>|IPromise<T>, second: Observable<T2>|IPromise<T2>, third: Observable<T3>|IPromise<T3>, fourth: Observable<T4>|IPromise<T4>, fifth: Observable<T5>|IPromise<T5>, sixth: Observable<T6>|IPromise<T6>, seventh: Observable<T7>|IPromise<T7>, eigth: Observable<T8>|IPromise<T8>): Observable<[T, T2, T3, T4, T5, T6, T7, T8]>;
    }
}

declare namespace VirtualDOM {
    // type VChild = VTree[] | VTree | string[] | string | undefined;
}


declare module 'rx-lite-dom' {
    export = Rx;
}
